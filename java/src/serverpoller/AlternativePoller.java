 ...
 * Feb 5, 2015
 */
public class AlternativePoller {
	
	// Milliseconds between each event firing
	private final int DELAY;
	
	private IServerFacade proxyFacade;
	private ClientFacade clientFacade;

	// For Testing
	public AlternativePoller(int delay) {
		this.DELAY = delay;
		setTimer();
	}
	 ...
	 * needed.
	 */
	public AlternativePoller(int delay, IServerFacade proxyFacade, ClientFacade clientFacade) {
		this.DELAY = delay;
